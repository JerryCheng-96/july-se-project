                ...
                <form class="layui-form" style="padding-top: 10%; ">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-input-block" style="margin-left: 5%;margin-right: 5%">
                            ...
                            <input type="radio" name="userType" value="engineer" title="工程师">
                            <input type="radio" name="userType" value="manager" title="管理员">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block" style="margin-left: 5%;margin-right: 5%">
...
<script>
    layui.use('form', function () {
        ...
        form.on('submit(formDemo)', function (data) {
            ...
            window.location.href = '/login.do?username=' + data.field.username + '&userType=' + data.field.userType;
            return false;
        });
    })
</script>
