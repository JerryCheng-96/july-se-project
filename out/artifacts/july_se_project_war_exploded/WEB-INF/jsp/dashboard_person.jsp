...
<div class="layui-layout layui-layout-admin">
    ...
    <div class="layui-body">
        <div class="layui-row" style="padding: 15px;">
            ...
            <span style="padding-left: 15px;"><a href="javascript:popup_layer_engineer()" class="layui-btn">工程师信息显示</a></span>
            <span style="padding-left: 15px;"><a href="javascript:popup_layer_engineer()" class="layui-btn">工程师信息修改</a></span>
            <span style="padding-left: 15px;"><a href="javascript:popup_layer_engineer()" class="layui-btn">学生信息显示</a></span>
            <span style="padding-left: 15px;"><a href="javascript:popup_layer_engineer()" class="layui-btn">学生信息修改</a></span>
            <span style="padding-left: 15px;"><a href="javascript:popup_layer_engineer()" class="layui-btn">班级信息修改</a></span>
            <span style="padding-left: 15px;"><a href="javascript:popup_layer_engineer()" class="layui-btn">小组信息修改</a></span>
            <span style="padding-left: 15px;"><a href="javascript:popup_layer_engineer()" class="layui-btn">教学任务信息查看</a></span>
            <span style="padding-left: 15px;"><a href="javascript:popup_layer_engineer()" class="layui-btn">教学任务信息修改</a></span>
            </div>
        </div>
